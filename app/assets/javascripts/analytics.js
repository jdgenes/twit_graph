...
window.onload = function () {
    ...
    var width = 800,
        ...
        txt = {font: '14px Helvetica, Arial', fill: "#000"},
    ...
    label.push(r.text(60, 27, "22 September 2008").attr(txt1).attr({fill: "#000"}));
    label.hide();
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot) {
            ...
            rect.hover(function () {
                ...
                label[1].attr({text: "posted on " + lbl}).show().stop().animateWith(frame, anim, {transform: ["t", lx, ly]}, 200 * is_label_visible);
                dot.attr("r", 6);
